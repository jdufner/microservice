...
@Component
@Scope("prototype")
public class AllCandidatesPrimesComputer extends AbstractPrimesComputer {

  private static final Logger LOG = LoggerFactory.getLogger(AllCandidatesPrimesComputer.class);
